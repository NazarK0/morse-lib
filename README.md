...
morse-lib = "0.5.0"
// for all features:
morse-lib = { version = "0.5.0", features = ["custom", "audio"] } 
// for custom Morse code only:
morse-lib = { version = "0.5.0", default-features = false, features = ["custom"] } 
// for custom Morse code only and audio features:
morse-lib = { version = "0.5.0", default-features = false, features = ["custom", "audio"] } 
```
